...
def negative_sampler_factory(code, train, val, test, item_count, sample_size, seed, save_folder):
    negative_sampler = NEGATIVE_SAMPLERS[code]
    return negative_sampler(train, val, test, item_count, sample_size, seed, save_folder)
